...
Feature: Location/Movement/Inventory Control Tab
  # Enter feature description here
    ...
    Scenario: Searching and adding multiple Location/Movement/Inventory records
        ...
        And the user clicks on result with text "CQA113.3"  . #Change num?
        ...
        And the user clicks on result with text "CQA113.2"  . #Change num?
        Then an "Edit Location/Movement/Inventory Control" form should be displayed # Be more specific?  
    ...
    Scenario: Cancel changes button #9
        ...
        And user clicks the "cancel changes" button at the top of the page 
